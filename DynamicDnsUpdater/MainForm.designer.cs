namespace DynamicDnsUpdater
{
    partial class MainForm
    {
        ...
        "ration time");
            ...
            this.infoTip.SetToolTip(this.txtUser, "The Username that you used when you registered your  account");
            // 
            // label5
            // 
        ...
        "ion (runs in backbround+log) (expert note: uses task scheduler)");
            ...
            this.infoTip.SetToolTip(this.txtHostname, "Hostname to be updated; for example \"something.ddns.mak-net.net\"");
            // 
            // label10
            // 
            ...
            this.infoTip.SetToolTip(this.label10, "Hostname to be updated; for example \"something.ddns.mak-net.net\"");
            // 
            // label11
            // 
        ...
        "lly added at the end, https is forced");
            ...
            this.txtUpdateLink.Text = "ddns.mak-net.net";
        ...
        "lly added at the end, https is forced");
            ...
            this.optLogAppDir.Checked = true;
        ...
        "/ethernet) or new ip, this can\'t be perfect so timed update will be always on");
            ...
            this.label2.Text = "Hostname (example: makflix.eu)";
            // 
            // trayIconMenu
            // 
            ...
            this.Text = "makLABS - Dynamic Dns Updater";
